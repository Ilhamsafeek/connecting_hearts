...
class _PaymentPageState extends State<Payment> {
  ...
  void initState() {
    super.initState();
    _customerData = StripePayments(this.mApiListener).getCustomerDataByMobile();
  }
        ...
        child: Column(children: <Widget>[
          ...
          ListTile(
            ...
            onTap: () async {
              ...
              var companyData =
                  await WebServices(this.mApiListener).getCompanyData();
              var data = await braintreePayment.showDropIn(
                  nonce: 'sandbox_24kjt8mg_y9tk96sm4x4chvyv', amount: "100.0");
              print("Response of the payment $data");

              // if(data['status']=='success'){
              // _scaffoldKey.currentState.showSnackBar(SnackBar(
              //   content: Text("Please wait until submit the donation.."),
              // ));
              // var saleResponse = await Braintree(mApiListener)
              //     .sale('88888', data['paymentNonce']);
