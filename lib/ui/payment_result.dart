...
class _PaymentResultState extends State<PaymentResult> {
  ...
  Widget doPaymentInitiation() {
    return FutureBuilder<dynamic>(
      future: WebServices(this.mApiListener).createStripeToken(), 
  ...
  Widget doCharging(String token) {
    return FutureBuilder<dynamic>(
      future: WebServices(this.mApiListener).stripeCharges(token), 
      builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
        List<Widget> children;
